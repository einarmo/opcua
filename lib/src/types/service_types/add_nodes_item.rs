...
impl crate::types::BinaryEncoder<AddNodesItem> for AddNodesItem {
    ...
    fn decode<S: std::io::Read>(
        ...
        let parent_node_id = <crate::types::expanded_node_id::ExpandedNodeId as crate::types::BinaryEncoder<
        ...
        >>::decode(stream, decoding_options)?;
        let requested_new_node_id = <crate::types::expanded_node_id::ExpandedNodeId as crate::types::BinaryEncoder<
            crate::types::expanded_node_id::ExpandedNodeId,
        >>::decode(stream, decoding_options)?;
        ...
        >>::decode(stream, decoding_options)?;
        let node_attributes = <crate::types::extension_object::ExtensionObject as crate::types::BinaryEncoder<
