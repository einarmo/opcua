...
impl crate::types::BinaryEncoder<CreateSessionResponse> for CreateSessionResponse {
    ...
    fn decode<S: std::io::Read>(
        ...
        >>::decode(stream, decoding_options)?;
        let authentication_token = <crate::types::node_id::NodeId as crate::types::BinaryEncoder<
            crate::types::node_id::NodeId,
        >>::decode(stream, decoding_options)?;
        let revised_session_timeout = <f64 as crate::types::BinaryEncoder<
            f64,
        >>::decode(stream, decoding_options)?;
        ...
        >>::decode(stream, decoding_options)?;
        let server_signature = <super::signature_data::SignatureData as crate::types::BinaryEncoder<
            super::signature_data::SignatureData,
        >>::decode(stream, decoding_options)?;
        let max_request_message_size = <u32 as crate::types::BinaryEncoder<
            u32,
        >>::decode(stream, decoding_options)?;
        Ok(Self {
            response_header,
